        ...
        <Box component="section" id="past" sx={{ py: 8, bgcolor: '#ffffff', minHeight: '100vh', position: 'relative' }}>
            <Container maxWidth="lg">
                ...
                <Box sx={{ 
                    ...
                    <Typography variant="body1" component="div" sx={{ fontSize: '110%', lineHeight: 1.45, mb: 4 }}>
                        It has been heavily revised in 2026: it now uses an Angular shell and header as a microfrontend, serving React components for most of the content. State passes between the two frameworks. This monorepo codebase is managed using Nx.
                    </Typography>
                    <Typography variant="body1" component="div" sx={{ fontSize: '110%', lineHeight: 1.45, mb: 4 }}>
